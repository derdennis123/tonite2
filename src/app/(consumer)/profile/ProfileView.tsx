    ...
    <div className="min-h-screen px-4 md:px-8 py-8 max-w-lg mx-auto space-y-6">
      ...
      <div className="space-y-1">
        ...
        <div className="p-4 rounded-xl flex items-center justify-between" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <button type="button" onClick={() => setPushEnabled(!pushEnabled)} className="w-11 h-6 rounded-full p-0.5 transition-all duration-300" style={{ background: pushEnabled ? 'linear-gradient(135deg, #6C5CE7, #A855F7)' : 'rgba(255,255,255,0.1)' }}>
        ...
        <div className="p-4 rounded-xl flex items-center justify-between" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
          ...
          <button type="button" onClick={() => setEmailEnabled(!emailEnabled)} className="w-11 h-6 rounded-full p-0.5 transition-all duration-300" style={{ background: emailEnabled ? 'linear-gradient(135deg, #6C5CE7, #A855F7)' : 'rgba(255,255,255,0.1)' }}>
      ...
      <div className="space-y-1">
        ...
        <button type="button" onClick={signOut} className="w-full p-4 rounded-xl flex items-center justify-between" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)' }}>
